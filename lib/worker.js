...
function personalize(html, email) {
  ...
  // The in-body link points at the human-friendly confirmation page; the
  // signed token lets the page (and the one-click endpoint) verify the
  // request actually came from a valid email we sent.
